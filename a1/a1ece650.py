    ...
    for i in intersections:
        ...
        for v in inter_dict:
            if distance([x for x in vertices if x != i and x != v], i, v) != 1 and (v != i) and (
              ...
              #  print("passed first distance test")
             #   print("i is ",i,"v is ",v)
                for m in inter_dict[i]: # for all the lines that make up the intersection i
                  #  print("m is ",type(m))
                    if type(m) is tuple:     # if more than 2 lines make up the intersection then it is a list
                       # print("intersection lines is a list")
                   ...
                   #             print("a is ",type(a))
                                if type(a) is  tuple: # if v is also made up by a list of lines (>2)
                                  #  print("lines of i also a list , intersection for vertex point is a list")
                                    for b in a:     # for each line in that list of lines
                                        if j == b:  # if any line making v is in the list of lines making i
                                 #           print("fails after this if add 1 doesnt appear")
                                            #           print("adding 1", (i, v))
                                            edges.append((i, v))   # append i,v since they lie on the same line and no vertex between them
                                else:   #if v is made by just 2 lines
                                #    print("lines of i also a list, intersection for vertex point is not a list")
                      ...
                      #  print("intersection lines is not a list")
                        for c in inter_dict[v]:  # for all the lines that make up the other intersection
                        #    print("c is ",c)
                            if type(c) is tuple: # if more than 2 lines intersect to make v
                                #print("intersection for vertex point is more than 1")
                                ...
                                #print("intersection for vertex point is not a list")
                                if m == c: #c is a single line
                                #    print("adding 4", (i, v))
                                    edges.append((i, v))
    ...
    while True:
        ...
        if input_line == '':
            ...
            if cmd == 'a':
                ...
                #for k, s in enumerate(street_db):
                 #   if s

                    # print('Lines are : {} and {} \n'.format(coordinates[i], coordinates[i + 1]))
                if street == []:
