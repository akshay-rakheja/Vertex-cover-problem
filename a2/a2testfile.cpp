...
bool BFS(int v_num, int start, int end, vector<vector<int> >adj_list,int pred[], int distance[])
{
    vector<int> queue;
...
vector<int>  returnPath(int v_num, int start,
                           int end, vector<vector<int> >adj_list)
{
    int pred[v_num];
    int distance[v_num];
    vector<int> path;
...
void add_edge(int start, int end, vector<vector<int> >adj_list) 
{
...
int main() {
    ...
    unsigned int v_num;  // # of vertices
    unsigned int v_start;  //start id of vertex
    unsigned int v_end;  // ending id of vertex
